...
class HkSizes {
  ...
  static const double fontSizeMd = 14.0; // medium
  ...
  // Card sizes
  static const double homeCardRadius = 58.0;
  ...
  // Map Zoom -> its ideal zoom
  static const double zoom = 14.4746;

  // Google Details
  static const double googleImagesHeight = 200;
  static const double googleImagesRadius = 16.0;
